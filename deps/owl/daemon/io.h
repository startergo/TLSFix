...
/* Darwin's injection path rejects a 1501-byte QoS frame generated from the
 * old 1450-byte TAP MTU. Reserve space for radiotap, QoS, LLC, AWDL and FCS. */
#define OWL_DARWIN_TAP_MTU 1400
#include <net/if.h>
#include <limits.h>
